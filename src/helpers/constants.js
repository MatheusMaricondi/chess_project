...
const table_pieces = () => {
    const { game_historic_, engine_settings_ } = modifiers
    ...
    let pieces_list = (whiteTurn && !engine_settings_.analise) ? lowerPieces : upperPieces
    let target_list = (whiteTurn && !engine_settings_.analise) ? upperPieces : lowerPieces
